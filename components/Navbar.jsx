                    ...
                    <div className="hidden md:flex space-x-4">
                        {NAV_LINKS.map((link) => (
                            <Link
                                ...
                                href={link.href}
                                prefetch={true}
                                className={`text-gray-600 hover:text-blue-900 ${pathname === link.href ? 'font-bold' : ''}`}
                            >
                                {link.label}
                            </Link>
                        ))}
                    ...
                    <div className="md:hidden bg-white px-4 py-2 space-y-2">
                        {NAV_LINKS.map((link) => (
                            <Link
                                ...
                                href={link.href}
                                prefetch={true}
                                className={`block text-gray-600 hover:text-blue-900 ${pathname === link.href ? 'font-bold' : ''}`}
                        ...
                        <Link
                            href="https://portal.cashmetanzania.com/login"
                            prefetch={true}
                            className="bg-blue-900 text-white px-4 py-2 rounded-full w-full text-center block"
                        >
                            Log In
                        </Link>
                    </div>
